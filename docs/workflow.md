...
5. 작품 `PROJECT.md 섹션 12` 8단계 작업 순서대로 진행
...
2. 체인 주입 확인 (PROJECT.md 섹션 6 매핑 표 참조)
...
9. 결과 Compliance 확인
 - `prompt-lab/cut-intents.md` 또는 PROJECT.md 섹션 10 EP별 체크포인트 대조
...
### 2.2-B 앵커 기반 컷 (예: EP1 C00, EP2 C01 등 -- `PROJECT.md 섹션 12 Step 3` 9종)
...
- **평가 기준**: PROJECT.md 섹션 11 표 + 각 EP별 체크포인트 (섹션 10)
