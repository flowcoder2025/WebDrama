...
- [OK] "A Korean woman in her early 30s standing against a plain light gray studio background."
- [NG] "Korean woman, 30s, gray background, studio, portrait"
...
- [NG] 교실 전체를 다시 묘사 (1282자)
- [OK] "The exact same classroom as the reference. Only the lighting changes: golden hour sunset..."

**"keep identical" + 변경점만 짧게** 패턴.

### 6. 캐릭터 Reference 멘션 시 얼굴 + 핵심 의상 동시 언급

[NG] "The same girl as the reference in her school uniform."
(교복만 언급 -> 얼굴 변형됨)

[NG] "The same girl as the reference, maintaining her exact facial features..."
(얼굴만 강조, 교복 생략 -> 의상 변형됨)

[OK] "The same woman as the reference, maintaining her exact facial features, face shape, hairstyle, and appearance, wearing her beige merino-knit top and charcoal wide-leg slacks."
...
### 8. 멘션은 문장 안에 분산 배치
- [NG] "@img1 @img2 @img3 The girl stands at the entrance, ..."
- [OK] "@img2 The girl stands at @img1 the entrance, and @img3 the boy approaches from behind."
...
### 3. 복합 액션 금지 -- 한 번의 동작만
- [NG] "She stands up, walks to the window, and opens it."
- [OK] "She blinks slowly, then a single tear traces down her cheek."
...
작품 단위로 립싱크 예외 컷이 있을 수 있음 (예: 「나는 괜찮아요」는 3컷 예외 -- PROJECT.md 섹션 8 참조).
